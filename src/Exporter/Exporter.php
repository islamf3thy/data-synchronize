...
namespace BinaLinq\DataSynchronize\Exporter;

use BinaLinq\Base\Facades\Assets;
use BinaLinq\Base\Facades\BaseHelper;
use BinaLinq\DataSynchronize\Concerns\Exporter\HasEmptyState;
use BinaLinq\DataSynchronize\Enums\ExportColumnType;
use Carbon\Carbon;
...
abstract class Exporter implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithHeadings, WithMapping
{
    ...
    /**
     * @return \BinaLinq\DataSynchronize\Exporter\ExportColumn[]
     */
    ...
    /**
     * @return \BinaLinq\DataSynchronize\Exporter\ExportCounter[]
     */
